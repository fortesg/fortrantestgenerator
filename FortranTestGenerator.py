...
from config_fortrantestgenerator import SOURCE_FOLDER, SOURCE_FILES, TEMPLATE_FOLDER, BACKUP_SUFFIX, TEST_SOURCE_FOLDER, GRAPH_BUILDER, IGNORE_GLOBALS_FROM_MODULES, IGNORE_DERIVED_TYPES, EXCLUDE_MODULES, FTG_PREFIX
...
def main():
    ...
    if args.restore:
        ...
        if args.capture:
            ...
            generator = CaptureCodeGenerator(SOURCE_FILES, TEMPLATE_FOLDER, GRAPH_BUILDER, BACKUP_SUFFIX, EXCLUDE_MODULES, IGNORE_GLOBALS_FROM_MODULES, IGNORE_DERIVED_TYPES) 
        else:
            print 'Generate replay code'
            generator = ReplayCodeGenerator(SOURCE_FILES, TEMPLATE_FOLDER, TEST_SOURCE_FOLDER, GRAPH_BUILDER, BACKUP_SUFFIX, EXCLUDE_MODULES, IGNORE_GLOBALS_FROM_MODULES, IGNORE_DERIVED_TYPES, FTG_PREFIX)
